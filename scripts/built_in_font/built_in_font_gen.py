...
parser.add_argument('-r', '--range',
					nargs='+',
					metavar = 'start-end',
					default=['0x20-0x7F,0xA1-0xAC,0xAE-0xFF,0xB0,0x2022'],
					help='Ranges and/or characters to include. Default includes ASCII + Latin-1 (acentos españoles). E.g. -r 0x20-0x7F, 0x200, 324')
